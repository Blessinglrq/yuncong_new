    ...
    def run_epoch(self, mode):
        ...
        with torch.set_grad_enabled(mode == 'train'):
            ...
            for index, (images, all_gt_bboxes, path) in enumerate(dataloader):
                ...
                loss = loss_class + loss_reg             # diffirent from paper
                ...
                if not index % Config.LOSS_LOG_STRIDE:
                    ...
                    print(mode, self.current_epoch, index, total_iter, loss_class.data, loss_reg.data, loss.data)
